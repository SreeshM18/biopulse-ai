      ...
      <footer className="border-t border-slate-800/80 bg-[#060913]/90 py-6 px-4 text-center text-xs text-slate-500 space-y-2">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center space-x-2">
            ...
            <span className="font-bold text-slate-300">BioPulse AI • NOVA Anatomy Twin</span>
            <span>— Micro-to-Macro 3D Digital Avatar & Clinical Health Platform</span>
          </div>

          <div className="flex items-center space-x-4 font-mono text-[11px] text-slate-400">
            <span className="flex items-center space-x-1 text-cyan-400">
              <Brain className="w-3 h-3 animate-pulse" />
              <span>Anatomy Twin 3D Active</span>
            </span>
            <span>•</span>
            <span className="flex items-center space-x-1 text-purple-400">
              <Layers className="w-3 h-3" />
              <span>8 Layers Multi-Scale</span>
            </span>
            <span>•</span>
